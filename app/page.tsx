  ...
  return (
      <div className="container mx-auto h-full my-12 bg-secondary">
        <div className="flex flex-col items-center justify-center px-2 text">
          <h2 className='font-extrabold py-8 mx-4 xl:mx-0 w-full xl:w-[1000px] text-center text-xl xl:text-6xl text-primary'>Simplify Your Business Expenses with ExpenseXpress</h2>
